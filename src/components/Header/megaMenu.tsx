...
const MegaMenu = ({ megaMenuTitle }) => {
  return (
    <div className="w-full absolute top-0 translate-x-[-42%] translate-y-[4%] left-2/4 transition group-hover:translate-y-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out group-hover:transform z-50 md:max-w-max lg:min-w-[600px] xl:min-w-[800px] transform">
