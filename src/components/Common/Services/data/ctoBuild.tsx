...
export const ReactCTO: TechServiceOne[] = [
  {
    imageUrl: "/module.svg",
    heading: "High seniority level and technical skills",
    description: "Build your technology assets from the very beginning",
  },
  {
    imageUrl: "/performance.svg",
    heading: "Ability to scale a team in days",
    description:
  ...
  {
    imageUrl: "/high.svg",
    heading: "Newest trends in practice",
    description:
  ...
  },
  {
    ...
    heading: "Battle-tested process",
    description:
      "You can easily adapt to changes and stay on track at the same time",
  },
];

export const NextJsCTO: TechServiceOne[] = [
  {
    imageUrl: "/module.svg",
    heading: "High seniority level & technical skills",
    description: "Benefit from the high technical skills of our Next.js devs",
  },
  {
    imageUrl: "/performance.svg",
    heading: "Ability to scale a team in days",
    description: "Scale your team up or down as you see fit",
  },
  {
    imageUrl: "/seo.svg",
    heading: "Cloud & serverless experience",
    description:
      "Use our cloud experience to improve scalability, performance & cost optimization",
  },
  {
    imageUrl: "/reusable.svg",
    heading: "Vast portfolio of Next.js projects",
    description:
      "Having worked with Node and React on a daily basis, we use Next.js regularly",
  },
  {
    imageUrl: "/high.svg",
    heading: "JavaScript specialization",
    description:
  ...
  },
  {
    imageUrl: "/supportive.svg",
    heading: "Battle-tested process",
    description: "Designed to be consistent and flexible at the same time",
  },
];

export const NodeCTO: TechServiceOne[] = [
  {
    imageUrl: "/module.svg",
    heading: "High seniority level and technical skills",
    description: "Build your technology assets from the very beginning",
  ...
  {
    imageUrl: "/seo.svg",
    heading: "Cloud and serverless experience",
    description:
      "Your software prepared for scalability, high performance and cost optimization",
  },
  {
    imageUrl: "/reusable.svg",
    heading: "Microservices – ready approach",
    description:
      "Build modern architectures that support change and fast growth",
  },
  {
    imageUrl: "/high.svg",
    heading: "Ready-to-Run Modules",
    description: "Save weeks of time on setting up a core of your app",
  },
  {
    imageUrl: "/supportive.svg",
    heading: "Battle-tested process",
    description: "Adapt to change and stay on the track at the same time",
  },
];
