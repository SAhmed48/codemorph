...
import { ReactBlogs } from "@/components/Common/Services/data/blogs";
import { ReactTech } from "@/components/Common/Services/data/LangTech";
...
const tech: textParts[] = [
  { text: "The Software House is one of the " },
  { text: "most-", highlight: true },
  { text: "highly recommended", highlight: true },
  { text: " web development companies in the world" },
];
  ...
  return (
    <div className="bg-white text-gray-900 font-['Inter']">
      ...
      <CallToAction
        ...
        description="Build or extend your React.js team"
        buttonText="Book Free Consultation"
